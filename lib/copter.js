...
Copter.prototype.setpoint = function(roll, pitch, yaw, thrust, hover)
{
	if (this.xmode)
	{
	...
	return this.driver.setpoint(roll, pitch, yaw, thrust, hover);
};
...
Copter.prototype.setSupportsHover = function(h)
{
	this.driver.setSupportsHover(h);
};
Copter.prototype.getSupportsHover = function() { return this.driver.getSupportsHover();}
Copter.prototype.__defineGetter__('supportsHover', Copter.prototype.getSupportsHover);
Copter.prototype.__defineSetter__('supportsHover', Copter.prototype.setSupportsHover);
