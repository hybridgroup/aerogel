...
CrazyDriver.prototype.setpoint = function(roll, pitch, yaw, thrust, hover)
{
	var self = this,
		deferred = P.defer();
...
CrazyDriver.prototype.setSupportsHover = function(h)
{
	this.supportsHover = h;
}
CrazyDriver.prototype.getSupportsHover = function()
{
	return this.supportsHover;
}
